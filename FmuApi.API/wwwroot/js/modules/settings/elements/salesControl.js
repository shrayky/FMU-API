...
class SaleControllsConfigurationElement {
    constructor(id) {
        ...
        this.LABELS = {
            ...
            сheckIsOwnerField: "Проверять владельца марки",
            ...
            sendEmptyTrueApiAnswerWhenTimeoutError : "Генерирвать пустой ответ от честного знака при недоступности cdn",
    ...
    loadConfig(config) {
        if (config?.saleControlConfig) {
            ...
            this.сheckIsOwnerField = config.saleControlConfig.сheckIsOwnerField;
        ...
        elements.push(
            {
                padding: padding,
                rows: [
                    CheckBox(this.LABELS.banSalesReturnedWares, "saleControlConfig.banSalesReturnedWares", this.banSalesReturnedWares),
                    ...
                    CheckBox(this.LABELS.сheckIsOwnerField, "saleControlConfig.checkIsOwnerField", {value: this.сheckIsOwnerField}),
