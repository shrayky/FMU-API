...
class SaleControllsConfigurationElement {
    constructor(id) {
        ...
        this.LABELS = {
            ...
            resetSoldStatusForReturn: "Для возвратов - изменять стаус `Продано` для товаров (тарифный фронтол до 25 версии)",
            useBeerTaps: "Использовать пивные краны",
            markCheckResultSaveTitle: "Сохранение результатов проверки марки в текстовый файл (для печати через скрипты драйвера ккт атол):",
